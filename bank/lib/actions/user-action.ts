...
export const exchangePublicToken = async ({
  ...
  try {
    ...
    // Create a processor token for Dwolla using the acess token and accont ID
    const reqeust: ProcessorTokenCreateRequest = {
      access_token: accessToken,
    ...
    // and funding source URL, and sharable ID
    ...
    // Revalidate thr path to reflect the changes
    revalidatePath("/");
